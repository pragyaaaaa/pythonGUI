#
# Original theme for GTK-2:
# http://gnome-look.org/content/show.php/Blue+Elegance+Light?content=164806
#

namespace eval ::ttk::theme::BlueElegance {

    package provide ttk::theme::BlueElegance 0.1
    ...
    LoadImages [file join [file dirname [info script]] BlueElegance]
    ...
    ::ttk::style theme create BlueElegance -settings {
